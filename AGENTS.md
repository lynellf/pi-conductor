...
- **Phase 5 (cost + observability)** — Task 19 complete (commit `3c2ce65`,
  324 tests / 26 files). Task 20 (default v1 role bundle + E2E fixtures) next.
  See `docs/orchestrator-fsm-plans/phase-5-cost-observability.md`.
