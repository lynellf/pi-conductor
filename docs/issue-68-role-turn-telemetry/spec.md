...
The provided unauthenticated issue API lookup previously returned HTTP
...
issue body appears later and conflicts with this contract, reconcile it in a
...
1. The actual authenticated Issue #68 body was unavailable. The task
