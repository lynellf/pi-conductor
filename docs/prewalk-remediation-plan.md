...
- [ ] R6/R8: wire guide turn events to transformed executor-budget measurement, one warning, forced projection, cost/turn abort and recoverable Git checkpoint. Verify production/composite integration tests and focused budget/session suites.
