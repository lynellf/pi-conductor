...
import { collectPrewalkRetainedToolResults } from "./prewalk-retained-results.js";
  ...
  return createPrewalkRoleSession({
    ...
    buildProjection: ({ seed, exemplarSha }) => {
      const projection = buildPrewalkProjection({
        ...
        mutations: mutations(),
        retainedToolResults: collectPrewalkRetainedToolResults(
          guideSession.deliveryHistory(),
          args.cwd,
        ),
        executorEnvironment: {
          activeToolNames: executorTools,
